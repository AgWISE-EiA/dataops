...
#get the data
ds1 <- readRDS("~/agwise-datacuration/dataops/datacuration/Data/useCase_Rwanda_RAB/Potato/raw/SAnDMan-potato-fieldData.RDS")
...
ds1 <- ds1 %>% 
  ...
  dplyr::left_join(read.csv("~/agwise-datacuration/dataops/datacuration/Data/useCase_Rwanda_RAB/Potato/Landing/fieldData/RwaSIS_potato_trials_nutrient_rates.csv")) %>%
...
phd <- read.csv("~/agwise-datacuration/dataops/datacuration/Data/useCase_Rwanda_RAB/Potato/Landing/fieldData/RwaSIS_potato_trials_with_yield_data_2023-04-14_RwaSIS_PFR.csv") %>%
...
ds2 <- readRDS("~/agwise-datacuration/dataops/datacuration/Data/useCase_Rwanda_RAB/Potato/raw/RwaSIS_potato-2022A-fieldData.RDS")
...
ds3 <- readRDS("~/agwise-datacuration/dataops/datacuration/Data/useCase_Rwanda_RAB/Potato/raw/IFDC_potato-2014B-fieldData.RDS")
...
saveRDS(ds, "~/agwise-datacuration/dataops/datacuration/Data/useCase_Rwanda_RAB/Potato/transform/aggregated_fieldData.RDS")


# saveRDS(ds, "~/agwise-datacuration/dataops/datacuration/Data/useCase_Rwanda_RAB/Potato/transform/compiled_fieldData.RDS")
